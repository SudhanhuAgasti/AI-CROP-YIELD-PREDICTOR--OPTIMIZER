...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ✅ Safe redirect button (Schedule Demo)
    const redirectBtn = document.getElementById('redirect_id');
    if (redirectBtn) {
        redirectBtn.addEventListener('click', function() {
            window.location.href = 'schedule-demo.html';  // <-- Schedule Demo page
        });
    }

    // ✅ Demo Button Redirect (View Demo Dashboard)
    const demoBtn = document.getElementById("demoBtn");
    if (demoBtn) {
        demoBtn.addEventListener("click", () => {
            window.location.href = "dashboard.html";  // <-- Demo Dashboard page
        });
    }
